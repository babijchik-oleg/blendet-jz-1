...
// }
// console.log(calculateAverage(1, "hello", true, 45, {name: "Joan"}, [23, 35, 4]));
...
//   const newArray = [];
//   for (let i = 0; i < array.length - 1(do predposlednego chisla, tak kak po ysloviju beret sosednie chisla); i++) {
//     newArray.push(array[i] + array[i + 1]);
//   }
//   return newArray;
// }

// console.log(createArray(someArr));
